      ...
      <v-container fluid>
        <v-card class="container">
          ...
          <v-layout align-center>
            <v-switch :label="dark.enabled ? `On` : `Off`" hide-details v-model="dark.enabled"></v-switch>
            <v-checkbox :label="`Auto`" :disabled="!dark.enabled" hide-details v-model="dark.auto"></v-checkbox>
            <v-menu ref="from_menu" :disabled="!dark.auto" lazy :close-on-content-click="false" v-model="from_menu" transition="scale-transition"
              offset-y full-width :nudge-right="40" max-width="290px" min-width="290px" :return-value.sync="dark.from">
            ...
            <v-menu ref="to_menu" :disabled="!dark.auto" lazy :close-on-content-click="false" v-model="to_menu" transition="scale-transition"
              offset-y full-width :nudge-right="40" max-width="290px" min-width="290px" :return-value.sync="dark.to">
